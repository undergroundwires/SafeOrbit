...
namespace SafeOrbit.Memory
{
    ...
    public class SafeMemoryStream : Stream
    {
        ...
        ///     <see cref="Zeroize" /> is true as default.
        /// </summary>
        public SafeMemoryStream()
        {
        }

        public SafeMemoryStream(bool zeroize)
        {
            Zeroize = zeroize;
        }
        ...
        /// <summary>
        ///     Specifies whether or not to zeroize ephemeral memory after it has been read.
        ///     If set to true, degrades performance. True as default.
        ///     somewhat.
        /// </summary>
        /// <value>
        ///     <c>true</c> if zeroize; otherwise, <c>false</c>.
        /// </value>
        public bool Zeroize { get; } = true;
        ...
        public override void Write(byte[] buffer, int offset, int count)
        {
            ...
            if (Zeroize) Array.Clear(buffer, offset, count);
            lock (_queue)
            {
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            lock (_readLockObj)
            {
                ...
                while ((position < finalPosition) && ((false == _closed) || (internalLength > 0)))
                {
                    ...
                    if (Zeroize) Array.Clear(_currentBlock, _currentBlockPosition, bytesToRead);
        ...
        /// <summary>
        /// Releases the unmanaged resources used by the <see cref="SafeMemoryStream" /> and optionally releases the managed resources.
        /// </summary>
