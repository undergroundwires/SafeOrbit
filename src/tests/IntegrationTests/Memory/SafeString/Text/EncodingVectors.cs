    ...
    public static class EncodingVectors
    {
        ...
        private static readonly byte[][] Utf16BigEndianBytes =
        {
            ...
            new byte[]
            {
                ...
                0, 47, 0, 92, 0, 32, 0, 100, 0, 48, 0, 76, 0, 48, 0, 82, 0, 32, 0, 53, 0, 49, 0, 55, 0, 32, 0, 52, 0,
                47,
        ...
        private static readonly byte[][] Utf16LittleEndianBytes =
        {
            ...
            new byte[]
            {
                ...
                47, 0, 92, 0, 32, 0, 100, 0, 48, 0, 76, 0, 48, 0, 82, 0, 32, 0, 53, 0, 49, 0, 55, 0, 32, 0, 52, 0, 47,
                0,
        ...
        public static IEnumerable<TestCaseData> AsciiBytes_To_Utf16LittleEndianBytes_Vector
        {
            get
            {
                ...
                yield return new TestCaseData(
                    ...
                    new byte[]
                    {
                        76, 0, 111, 0, 114, 0, 101, 0, 109, 0, 32, 0, 105, 0, 112, 0, 115, 0, 117, 0, 109, 0, 32, 0,
                        100,
                ...
                yield return new TestCaseData(
                    ...
                    new byte[]
                    {
                        76, 0, 48, 0, 82, 0, 51, 0, 47, 0, 92, 0, 47, 0, 92, 0, 32, 0, 49, 0, 80, 0, 53, 0, 85, 0, 47,
                        0,
            ...
            get
            {
                ...
                yield return new TestCaseData(
                    ...
                    new byte[]
                    {
                        ...
                        100, 0, 111, 0, 108, 0, 111, 0, 114, 0, 32, 0, 115, 0, 105, 0, 116, 0, 32, 0, 97, 0, 109, 0,
                        101,
                        0, 116
                    });
                yield return new TestCaseData(
                    ...
                    new byte[]
                    {
                        0, 76, 0, 48, 0, 82, 0, 51, 0, 47, 0, 92, 0, 47, 0, 92, 0, 32, 0, 49, 0, 80, 0, 53, 0, 85, 0,
                        47,
